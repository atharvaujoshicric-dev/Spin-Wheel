...
st.markdown("""
    ...
    .stApp {
        background-image:
            ...
            repeating-linear-gradient(90deg, transparent, transparent 60px, rgba(201,168,76,0.025) 60px, rgba(201,168,76,0.025) 61px) !important;
    }
    ...
    .wheel-ring {
        ...
        background: conic-gradient(
            from 0deg,
            #1C1D26 0deg 45deg,   #232430 45deg 90deg,
            #1C1D26 90deg 135deg, #232430 135deg 180deg,
            #1C1D26 180deg 225deg,#232430 225deg 270deg,
            #1C1D26 270deg 315deg,#232430 315deg 360deg
        );
        box-shadow:
            0 0 0 3px var(--gold),
    ...
    .wheel-ring::before {
        ...
        background: conic-gradient(
            from 0deg,
            transparent 0deg 44deg,   rgba(201,168,76,0.55) 44deg 46deg,
            transparent 46deg 89deg,  rgba(201,168,76,0.55) 89deg 91deg,
            transparent 91deg 134deg, rgba(201,168,76,0.55) 134deg 136deg,
            transparent 136deg 179deg,rgba(201,168,76,0.55) 179deg 181deg,
            transparent 181deg 224deg,rgba(201,168,76,0.55) 224deg 226deg,
            transparent 226deg 269deg,rgba(201,168,76,0.55) 269deg 271deg,
            transparent 271deg 314deg,rgba(201,168,76,0.55) 314deg 316deg,
    ...
    .spinning { animation: spin-ease 3s cubic-bezier(0.22, 1, 0.36, 1) forwards; }
    ...
    .prize-reveal .label { font-size: 0.6rem; letter-spacing: 0.35em; color: var(--text-muted); margin-bottom: 8px; }
    .prize-reveal .value { font-family: 'Cinzel', serif; font-size: 1.35rem; color: var(--gold-light); letter-spacing: 0.1em; }
    .prize-reveal .sub   { font-size: 0.72rem; color: var(--text-muted); margin-top: 6px; line-height: 1.5; }
    ...
    .gold-divider::after { background: linear-gradient(90deg, var(--gold-border), transparent); }
